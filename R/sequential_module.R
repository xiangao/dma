...
#'
#' Creates a factory function that returns a sequential neural network module
#' with the specified architecture. Used for Riesz representer estimation.
#'
...
#'
#' @return A function that takes input dimension and returns a torch nn_module.
#' @export
