...
The direct pathway (A→Y, purple vs blue) creates a location shift of about
0.8. The mediator pathway (A→M→Y, orange) shifts the distribution and changes
its shape because of the $M^2$ non-linearity. This is the kind of pattern a
mean-only decomposition hides.
